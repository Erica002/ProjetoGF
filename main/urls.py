...
urlpatterns = [
    ...
    # Gráficos
    path('grafico_por_categoria/', views.grafico_por_categoria, name="grafico_por_categoria"),
    path('grafico_despesas_por_mes/', views.grafico_despesas_por_mes, name="grafico_despesas_por_mes"),
    path('grafico-mensal', views.mostra_grafico_mensal, name="grafico-mensal"),
    path('grafico_despesas_por_ano/', views.grafico_despesas_por_ano, name="grafico_despesas_por_ano"),
    path('grafico-anual', views.mostra_grafico_anual, name="grafico-anual"),
    path('grafico_renda_por_mes/', views.grafico_renda_por_mes, name="grafico_renda_por_mes"),
    path('grafico_renda_por_ano/', views.grafico_renda_por_ano, name="grafico_renda_por_ano"),
